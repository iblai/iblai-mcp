"""
Authentication Manager for iblai-blog
...
class AuthManager:
    ...
    def _load_from_env(self) -> AuthConfig:
        ...
        auth_type_str = os.getenv("BLOG_AUTH_TYPE", "none").lower()
        ...
        return AuthConfig(
            ...
            api_key_header=os.getenv("BLOG_API_KEY_HEADER", "X-API-Key"),
            bearer_token=os.getenv("BLOG_BEARER_TOKEN"),
            basic_username=os.getenv("BLOG_BASIC_USERNAME"),
            basic_password=os.getenv("BLOG_BASIC_PASSWORD"),
            custom_header_name=os.getenv("BLOG_CUSTOM_HEADER_NAME"),
            custom_header_value=os.getenv("BLOG_CUSTOM_HEADER_VALUE"),
            oauth2_client_id=os.getenv("BLOG_OAUTH2_CLIENT_ID"),
            oauth2_client_secret=os.getenv("BLOG_OAUTH2_CLIENT_SECRET"),
            oauth2_token_url=os.getenv("BLOG_OAUTH2_TOKEN_URL"),
            oauth2_scope=os.getenv("BLOG_OAUTH2_SCOPE"),
        )
